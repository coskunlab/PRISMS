...
class HarvardPump:
    ...
    """
    def __init__(self, port = '/dev/ttyACM0', baudrate=19200, timeout=1, address="00"):
        self.port = port
        self.baudrate = baudrate
    ...
    def set_infusion_rate(self, rate_value, rate_unit_key):
        ...
        if rate_unit_key not in self.RATE_UNIT_CODES:
             print(f"Error: Invalid rate unit key '{rate_unit_key}'")
             return None
        pump_unit_code = self.RATE_UNIT_CODES[rate_unit_key]
