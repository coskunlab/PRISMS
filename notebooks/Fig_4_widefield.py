...
pklPath = SCRIPT_DIR / ".." / "data" / "Human Tonsil HuFPT161 Sv2" / "18Nov2024 slide 03 cycle 2 IF Nikon" / "12 PKL single cell"
...
saveFigure(fig, 'Fig_4_widefield_RNA_counts_per_cell_boxplot')
...
saveFigure(fig, 'Fig_4_widefield_pearson_correlation_heatmap')
