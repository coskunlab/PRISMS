...
pklPath = SCRIPT_DIR / ".." / "data" / "Human tonsil HuFPT161 SW5" / "14Mar2025 slide 042 cycle 2 HCR Squid" / "09 PKL single cell"
...
saveFigure(fig, 'Fig_5_RNA_counts_per_cell_boxplot')
...
saveFigure(fig, 'Fig_5_pearson_correlation_heatmap')
